# Santander Dev Week - Frontend Angular

## Development server

Run `ng serve` for a dev server. Navigate to `http://localhost:4200/`. 

## Aplicação em produção no github pages
[Aplicação](https://leandrohv.github.io/santander-dev-week-frontend/)


# Material de Apoio - Bootcamp Santander

## Figma
[Layout](https://www.figma.com/file/45hA17RoXlyM1SyMnqxJlj/bootcamp-santander)

## Aula 1: Configurando Ambiente - Frontend
[Vídeo](https://www.youtube.com/watch?v=k4tz8D13dZI)
...
[Vídeo](https://www.youtube.com/watch?v=rq8F6--8sOU)
